...
echo "2. Select a case type to join the queue"
echo "3. Navigate through the flowchart or chat with AI"
echo "4. Access admin dashboard at /admin for facilitators"
echo ""
